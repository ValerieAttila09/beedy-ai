export const Icons = {
  ...
  beedyAI: () => (
    <svg className="size-5 shrink-0" xmlns="http://www.w3.org/2000/svg" width="580" height="580" viewBox="0 0 580 580" fill="none">
      <g clipPath="url(#clip0_23_111)">
        <rect width="580" height="580" fill="white" />
        <rect width="580" height="580" fill="white" />
        <path d="M289.5 103L451.88 196.75V384.25L289.5 478L127.12 384.25V196.75L289.5 103Z" fill="black" />
        <mask id="mask0_23_111" style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="38" y="0" width="252" height="435">
          <path d="M38.8501 0H290V290L38.8501 435V0Z" fill="#9114CA" />
        </mask>
        <g mask="url(#mask0_23_111)">
          <path d="M38.8501 0H290V290L38.8501 435V0Z" fill="#9114CA" />
          <rect x="14" y="391.608" width="322.816" height="50" transform="rotate(-30 14 391.608)" fill="white" />
        </g>
        <mask id="mask1_23_111" style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="290" y="145" width="252" height="435">
          <path d="M541.15 580H290V290L541.15 145V580Z" fill="#1797FF" />
        </mask>
        <g mask="url(#mask1_23_111)">
          <path d="M541.15 580H290V290L541.15 145V580Z" fill="#1797FF" />
          <rect x="259.187" y="307.553" width="325.106" height="50" transform="rotate(-30 259.187 307.553)" fill="white" />
        </g>
      </g>
      <defs>
